...
class PatchContainer {
    ...
    createUI() {
        ...
        label.innerHTML = "<strong>選擇文件</strong> 或拖移過來";
        ...
        container.appendChild(createElementClass('h5', null, '點擊版本名字可以查看'));
    ...
    loadFile(file) {
        ...
        reader.onload = function (e) {
            ...
            if (!found) {
                ...
                self.errorDiv.innerHTML = "沒有找到100%的完整補丁";
            }
        };
...
class Patcher {
    ...
    loadBuffer(buffer) {
        ...
        if(this.validatePatches()) {
            ...
            this.successDiv.innerHTML = "文件加載成功!";
        } else {
